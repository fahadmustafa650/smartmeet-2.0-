...
class VisitorRunInAppointmentScreen extends StatefulWidget {
  static final id = '/visitor_run_in_appointment_screen';
  @override
  _VisitorRunInAppointmentScreenState createState() =>
      _VisitorRunInAppointmentScreenState();
}

class _VisitorRunInAppointmentScreenState
    extends State<VisitorRunInAppointmentScreen> {
  //VARIABLES
